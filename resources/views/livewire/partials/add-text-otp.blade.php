...
>
    @include('profile-filament::livewire.partials.text-otp-instructions')
        ...
        @if ($this->showCodeError)
            <div class="pr-2">
                <x-profile-filament::alert>
                    <p>{{ __('profile-filament::pages/security.mfa.text.code_verification_fail') }}</p>
                </x-profile-filament::alert>
            </div>
        @elseif ($codeValid)
            <div class="pr-2" id="2fa-code-verify-success">
                <x-profile-filament::alert color="success">
                    <p>{{ __('profile-filament::pages/security.mfa.text.code_verification_pass') }}</p>
                </x-profile-filament::alert>
            </div>
        @endif
